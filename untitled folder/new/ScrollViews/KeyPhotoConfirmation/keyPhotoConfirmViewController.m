...
- (void)viewDidLoad
{
    ...
    [CommonMethods setUpPageController1:self.pageController size:self.selectedRow1];
...
-(UICollectionViewCell*)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(curImage == nil){
        ...
        NSLog(@" curimage != nil");
//        cell.KeyImage.frame = cgrectm
        cell.KeyImage.image = curImage;
        
//        UIImageView* imgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 100, 100)];
//        imgView.image = curImage;
//        cell.KeyImage = imgView;

    }
    
    
//    UIImageView *newPageView = [[UIImageView alloc] initWithImage: [appDelegate.imagesArray objectAtIndex:indexPath.row]];
//    newPageView.contentMode = UIViewContentModeScaleAspectFit;
//    
//    CGRect frame = self.PicturesCollectionView.k;
//    frame.origin.x = 0.0f;
//    frame.origin.y = 0.0f;
//    
//    
//    newPageView.frame = frame;
//    [self.PicturesCollectionView addSubview:newPageView];
//
//    UIImage * result;
