...
-(void)getPhotoAuthImagesList : (NSString*) stringToAppend
{
...
//    
    //NSString *stringToAppend1 = [NSString stringWithFormat:@"searchImage.php?keyWord=e&ageGroup=1,2,3&eventId=1,2,3,5"];
...
-(void)getPhotoAuthImage:(NSString *)photoUrl forIndexPath:(NSIndexPath*)indexPath
{
//    id result =  [NetworkManager getFromServer:photoUrl useSession:NO  dataType:YES];
    
    
    NSString *urlString1 = [NSString
                            stringWithFormat:@"http://kcblastapp.com/getImage.php?img=upload/images/09-07 Dro.jpg&type=thumb"];
    
    NSString* escapedUrl1 = [urlString1
                             stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
    NSLog(@"urlStr = %@ , escURL= %@", photoUrl, photoUrl);
    id result =  [NetworkManager getFromServer:photoUrl useSession:NO  dataType:YES];
